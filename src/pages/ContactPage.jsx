...
export default function ContactPage({ onAuth }) {
  ...
  const inputStyle = (key) => ({ width: "100%", padding: "14px 18px", background: focused === key ? "rgba(201,168,76,0.03)" : "rgba(255,255,255,0.03)", border: `1px solid ${focused === key ? C.gold : "rgba(201,168,76,0.2)"}`, color: "#fff", fontSize: "14px", outline: "none", fontFamily: "'Cormorant Garamond',serif", transition: "all 0.25s", boxSizing: "border-box" });
        ...
        <div className="r-section" style={{ paddingBottom: "80px" }}>
          ...
          <div style={{ background: "linear-gradient(160deg, #0f0c08 0%, #1a1208 100%)", padding: "56px 48px", borderRight: "1px solid rgba(201,168,76,0.12)" }}>
            <div style={{ marginBottom: "48px" }}>
              ...
              <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "28px", fontWeight: 400, color: "#fff", lineHeight: 1.4 }}>Crafted in India,<br />Loved Worldwide</h2>
            </div>
            {[
          ...
          <div style={{ background: C.surface, padding: "56px 48px" }}>
            {sent ? (
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%", textAlign: "center" }}>
                ...
                <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: "24px", color: "#fff", marginBottom: "12px" }}>Message Received</h3>
