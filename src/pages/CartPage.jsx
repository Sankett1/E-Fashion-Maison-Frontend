...
function CartItem({ item, onQtyChange, onRemove }) {
  return (
    <div className="r-grid-cart-item" style={{
      ...
      {/* Info */}
      <div>
        <div style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"12px", letterSpacing:"0.08em", color:"#6b5c44", marginBottom:"6px" }}>
          {(item.category || "").toUpperCase()}
        </div>
        <h3 style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"20px", fontWeight:400, color:"#1a1208", margin:"0 0 6px" }}>
          {item.name}
        </h3>
        <p style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"12px", color:"#b0a08a", marginBottom:"20px" }}>
          Size: {item.size}
        </p>
        {/* Qty controls */}
        <div style={{ display:"flex", alignItems:"center", gap:"14px" }}>
          <div style={{ display:"flex", border:"1px solid rgba(201,168,76,0.25)", overflow:"hidden" }}>
            ...
            <span style={{ width:"36px", height:"36px", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"14px", color:"#1a1208", borderLeft:"1px solid rgba(201,168,76,0.2)", borderRight:"1px solid rgba(201,168,76,0.2)" }}>{item.qty}</span>
            <button onClick={() => onQtyChange(item.id, item.size, item.qty + 1)} style={{ width:"36px", height:"36px", background:"none", border:"none", cursor:"pointer", color:"#6b5c44", fontSize:"16px" }}>+</button>
          </div>
          <button onClick={() => onRemove(item.id, item.size)} style={{ display:"flex", alignItems:"center", gap:"6px", background:"none", border:"none", cursor:"pointer", color:"#b0a08a", fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"11px", letterSpacing:"0.1em", transition:"color 0.2s" }}
      ...
      <div style={{ textAlign:"right", paddingTop:"8px" }}>
        <div style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"18px", color:"#1a1208" }}>
          ₹{(item.price * item.qty).toLocaleString("en-IN")}
        </div>
        {item.qty > 1 && (
          <div style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"11px", color:"#b0a08a", marginTop:"3px" }}>
    ...
    <>
      <div className="r-section" style={{ paddingTop:"64px", background:"#f5f0eb", minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center" }}>
        <div style={{ textAlign:"center" }}>
          ...
          <h2 style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"32px", fontWeight:400, color:"#1a1208", marginBottom:"12px" }}>Your bag is empty</h2>
          <p style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"15px", color:"#6b5c44", marginBottom:"32px" }}>Discover our curated collection</p>
      ...
      <div style={{ paddingTop:"64px", background:"#f5f0eb", minHeight:"100vh" }}>
        <div className="r-section r-section-v" style={{ maxWidth:"1200px", margin:"0 auto" }}>
          <div style={{ display:"flex", alignItems:"baseline", gap:"16px", marginBottom:"48px" }}>
            <h1 style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"42px", fontWeight:400, color:"#1a1208" }}>Your Bag</h1>
            <span style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"14px", color:"#6b5c44" }}>{cart.length} {cart.length === 1 ? "item" : "items"}</span>
          </div>
          ...
          <div className="r-grid-cart" style={{ gap:"56px", alignItems:"start" }}>
            ...
            <div style={{ background:"#fff", padding:"36px", border:"1px solid rgba(201,168,76,0.15)", position:"sticky", top:"90px" }}>
              ...
              <h2 style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"24px", fontWeight:400, color:"#1a1208", marginBottom:"28px" }}>
                Order Summary
              </h2>
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:"14px", marginBottom:"24px" }}>
                {[
                  ...
                  <div key={row.label} style={{ display:"flex", justifyContent:"space-between" }}>
                    <span style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"14px", color:"#6b5c44" }}>{row.label}</span>
                    <span style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"14px", color: row.color || "#3a2e1e" }}>{row.val}</span>
                  </div>
                ))}
              </div>
              ...
              {!couponApplied ? (
                <div style={{ display:"flex", gap:"8px", marginBottom:"24px" }}>
                  <input
                    ...
                    style={{
                      ...
                      background:"transparent", fontFamily:"'DM Sans',system-ui,sans-serif",
                  ...
                  <button onClick={applyCoupon} style={{
                    ...
                    color:C.gold, fontFamily:"'DM Sans',system-ui,sans-serif",
                ...
                <div style={{ padding:"10px 14px", background:"rgba(122,184,122,0.08)", border:"1px solid rgba(122,184,122,0.2)", fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"12px", color:"#7ab87a", marginBottom:"24px" }}>
              ...
              <div style={{ display:"flex", justifyContent:"space-between", marginBottom:"28px" }}>
                <span style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"18px", color:"#1a1208" }}>Total</span>
                <span style={{ fontFamily:"'DM Serif Display',Georgia,serif", fontSize:"22px", color:"#1a1208" }}>₹{total.toLocaleString("en-IN")}</span>
              </div>
              ...
              <div style={{ textAlign:"center", marginTop:"14px" }}>
                <button onClick={() => navigate("/shop")} style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"12px", color:C.gold, background:"none", border:"none", cursor:"pointer", textDecoration:"underline", textUnderlineOffset:"3px" }}>
                  Continue Shopping
                </button>
              </div>
              ...
              <div style={{ marginTop:"24px", paddingTop:"20px", borderTop:"1px solid rgba(201,168,76,0.1)", display:"flex", justifyContent:"center", gap:"20px" }}>
                {["🔒 Secure", "🔄 Easy Returns", "🚚 Free Shipping"].map(t => (
                  <span key={t} style={{ fontFamily:"'DM Sans',system-ui,sans-serif", fontSize:"10.5px", color:"#b0a08a" }}>{t}</span>
                ))}
              </div>
            </div>
          </div>
