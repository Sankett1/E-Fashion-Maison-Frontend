  ...
  return (
    <>
      ...
      <div style={{ minHeight: "100vh", background: C.bg, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "40px" }}>
        <div style={{ fontFamily: "'DM Serif Display',Georgia,serif", fontSize: "120px", color: "rgba(201,168,76,0.15)", lineHeight: 1, marginBottom: "16px" }}>404</div>
        <div style={{ fontFamily: "'DM Serif Display',Georgia,serif", fontSize: "28px", color: "#fff", marginBottom: "12px" }}>Page Not Found</div>
